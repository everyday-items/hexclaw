...
|------|------|
| 语言 | Go 1.25+ |
| Agent 框架 | [Hexagon](https://github.com/hexagon-codes/hexagon) v0.4.5 |
| AI 基础库 | [ai-core](https://github.com/hexagon-codes/ai-core) v0.1.1 |
...
| 项目 | 说明 | 仓库 |
|------|------|------|
| **Hexagon** | Go AI Agent 框架 (核心引擎) v0.4.5 | [hexagon](https://github.com/hexagon-codes/hexagon) |
| **ai-core** | AI 基础能力库 (LLM/Tool/Memory) v0.1.1 | [ai-core](https://github.com/hexagon-codes/ai-core) |
